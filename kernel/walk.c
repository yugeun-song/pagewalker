 ...
 * Bulk read (command 2)
 *
 * Layered on the walk above: copy a run of bytes out of a target address
 * space by re-walking each page (frames are contiguous only within a leaf)
 * and vetting every frame as System RAM before touching it.
 * ------------------------------------------------------------------------- */
